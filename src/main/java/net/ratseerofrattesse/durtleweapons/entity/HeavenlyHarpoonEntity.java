package net.ratseerofrattesse.durtleweapons.entity;
...
public class HeavenlyHarpoonEntity extends PersistentProjectileEntity {
    ...
    public HeavenlyHarpoonEntity(EntityType<? extends HeavenlyHarpoonEntity> entityType, World world) {
        super(entityType, world);
    }

    public HeavenlyHarpoonEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.HEAVENLY_HARPOON, owner, world, stack, null);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
        this.tridentStack = stack;
    }

    public HeavenlyHarpoonEntity(World world, double x, double y, double z, ItemStack stack) {
        super(ModEntities.HEAVENLY_HARPOON, x, y, z, world, stack, stack);
        this.dataTracker.set(LOYALTY, this.getLoyalty(stack));
        this.dataTracker.set(ENCHANTED, stack.hasGlint());
        this.tridentStack = stack;
    }
    ...
    protected ItemStack asItemStack() {
        if (this.tridentStack == null || this.tridentStack.isEmpty()) {
            this.tridentStack = new ItemStack(ModItems.HEAVENLY_HARPOON);
        }
    ...
    protected ItemStack getDefaultItemStack() {
        return new ItemStack(ModItems.HEAVENLY_HARPOON);
    }
    ...
    static {
        LOYALTY = DataTracker.registerData(HeavenlyHarpoonEntity.class, TrackedDataHandlerRegistry.BYTE);
        ENCHANTED = DataTracker.registerData(HeavenlyHarpoonEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }

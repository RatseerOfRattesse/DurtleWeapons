...
public class HeavenlyHarpoonEntityRenderer extends EntityRenderer<HeavenlyHarpoonEntity> {
    ...
    public HeavenlyHarpoonEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    @Override
    public void render(HeavenlyHarpoonEntity tridentEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();

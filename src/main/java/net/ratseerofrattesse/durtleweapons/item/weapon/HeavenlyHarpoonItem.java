...
public class HeavenlyHarpoonItem extends TridentItem {

    public HeavenlyHarpoonItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!world.isClient()) {
            ...
            if (f == 0.0f) {
                HeavenlyHarpoonEntity tridentEntity = new HeavenlyHarpoonEntity(world, playerEntity, stack);
